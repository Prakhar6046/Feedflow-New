...
export const passwordPatternMessage = "Password Pattern is wrong.";
export const confirmPasswordMessage =
  "Confirm Password do not match with password.";
export const phonePatternMessage = "Please enter only numbers.";
export const phoneMaxLengthMessage = "Phone number must be exactly 10 digits.";
export const OnlyAlphabatsMessage = "Only alphabets allowed";
