  ...
  const columns = [
    {
      ...
      renderCell: (params: GridRenderCellParams) => (
        <Box display={"flex"} alignItems={"center"} gap={1.5}>
          {params.row.imageUrl ? (
            <img
              src={String(params.row.imageUrl)}
              width={40}
              height={40}
    ...
    { field: "role", headerName: "Role", flex: 1, sortable: true },
    {
      ...
      renderCell: (params: GridRenderCellParams) => (
        <Box display={"flex"} alignItems={"center"} gap={"12px"}>
          {params.row.organisation.imageUrl ? (
            <img
              src={String(params.row.organisation.imageUrl)}
              width={80}
              height={40}
            ...
            <Box
              ...
              alignItems={"center"}
              bgcolor={"rgba(145, 158, 171, 0.24)"}
              sx={{ width: 80, height: 40, borderRadius: "8px" }}
            >
              {/* Placeholder icon */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
    ...
    },
    {
      ...
      flex: 1,
      renderCell: (params: GridRenderCellParams) => (
        <Typography> {readableDate(params?.row.createdAt) ?? ""}</Typography>
      ),
    },
    {
      field: "actions",
