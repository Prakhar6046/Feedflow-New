              ...
              >
                ...
                >
                  ...
                  <Box display={"flex"} alignItems={"center"} gap={1.5}>
                    <Box  display={"flex"} justifyContent={"center"} alignItems={"center"} bgcolor={"rgba(145, 158, 171, 0.24)"} sx={{
                      width: 40,
                      height: 40,
                      borderRadius: "8px",
                    }}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="1.7em" height="1.7em" viewBox="0 0 24 24">
                        <g fill="none">
                          ...
                          <path fill="#637381" d="M16 14a5 5 0 0 1 4.995 4.783L21 19v1a2 2 0 0 1-1.85 1.995L19 22H5a2 2 0 0 1-1.995-1.85L3 20v-1a5 5 0 0 1 4.783-4.995L8 14zM12 2a5 5 0 1 1 0 10a5 5 0 0 1 0-10" />
                        </g>
                      </svg>
                    </Box>
